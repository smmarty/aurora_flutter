...
List<SearchData> _searchData = const [
  SearchData(1199, 451550, 'Fragment',
  ...
  SearchData(-750, 323750, 'Stamp seal (oval bezel) with cultic scene',
  ...
  SearchData(
      -500, 327499, 'Vessel with a lid', 'vessel and lid|calcite alabaster|'),
  SearchData(-500, 323925, 'Scarab seal with human head',
      'stamp seal|stone, mottled red and white|'),
  SearchData(1849, 443096, 'Headband',
  ...
  SearchData(
      ...
      'palette|calcite|'),
  SearchData(1249, 451551, 'Fragment',
  ...
  SearchData(1149, 451069, 'Earring, One of a Pair',
  ...
  SearchData(1799, 444633, 'Powder Horn',
  ...
  SearchData(937, 451504, 'Fragment of a Bowl',
      'fragment of a bowl|earthenware; glazed|ceramics'),
  SearchData(-750, 322308, 'Stamp seal (scaraboid) with cultic scene',
  ...
  SearchData(1849, 503639, 'Ney-Anbān/Habbān',
      'tulum|wood, cane, goat or kidskin|aerophone-reed vibrated-bagpipe'),
  SearchData(
      -750,
      326992,
      'Stamp seal (ovoid, in grooved mount with loop handle) with cartouches',
  ...
  SearchData(
      999, 455153, 'Fragment', 'fragment|earthenware; luster-painted|ceramics'),
  SearchData(-662, 323155, 'Jug', 'jug|ceramic|'),
  SearchData(-700, 326994, 'Stamp seal (scaraboid) with monster',
      'stamp seal|calcite|'),
  SearchData(-1630, 323118, 'Scarab seal ring',
      'stamp seal ring|jasper, green with gold mount and copper alloy ring|'),
  ...
  SearchData(-125, 327483, 'Votive plaque inscribed with Sabaean dedication',
      'relief|copper alloy|'),
  SearchData(849, 451530, 'Fragment',
      'fragment|earthenware; molded decoration, glazed|ceramics'),
  SearchData(
      899, 451499, 'Fragment', 'fragment|earthenware; unglazed|ceramics'),
  ...
  SearchData(1399, 451553, 'Fragment',
      'fragment|earthenware; slip painted and glazed|ceramics'),
  SearchData(1687, 453279, 'Calligraphic Plaque',
  ...
  SearchData(1199, 451558, 'Fragment',
      'fragment|earthenware; slip painted and glazed|ceramics'),
  SearchData(
      899, 451500, 'Fragment', 'fragment|earthenware; unglazed|ceramics'),
  SearchData(-1630, 324567, 'Scarab seal', 'stamp seal|jasper, green (?)|'),
  SearchData(849, 451568, 'Fragment',
      'fragment|stonepaste; slip painted and glazed|ceramics'),
  SearchData(1199, 451512, 'Fragment',
  ...
  SearchData(
      -700, 324013, 'Stamp seal (scarab) with monster', 'stamp seal|hematite|'),
  SearchData(787, 327822, 'Stamp seal', 'stamp seal|sandstone or siltstone ?|'),
  SearchData(849, 451562, 'Fragment',
      'fragment|earthenware; slip painted and glazed|ceramics'),
  SearchData(937, 451508, 'Fragment', 'fragment|earthenware; glazed|ceramics'),
  SearchData(-750, 322307, 'Stamp seal (scaraboid) with cultic banquet scene',
  ...
  SearchData(899, 451498, 'Fragment of a Cup',
      'fragment of a cup|earthenware; unglazed|ceramics'),
  SearchData(899, 451588, 'Fragment', 'fragment|earthenware; glazed|ceramics'),
  SearchData(
      849, 451543, 'Fragment', 'fragment|earthenware; splash glazed|ceramics'),
  SearchData(899, 451533, 'Fragment',
      'fragment|earthenware; molded decoration, glazed|ceramics'),
  SearchData(50, 324252, 'Sherd', 'sherd|ceramic|'),
  SearchData(937, 451505, 'Fragment of a Bowl',
      'fragment of a bowl|earthenware; glazed|ceramics'),
  SearchData(4, 323749, 'Stamp seal (scaraboid) with animals',
  ...
  SearchData(1875, 500989, 'Naqqareh',
  ...
  SearchData(
      1049, 451601, 'Fragment', 'fragment|earthenware; incised|ceramics'),
  SearchData(-662, 323169, 'Bowl', 'bowl|ceramic|'),
  SearchData(1199, 451564, 'Fragment',
      'fragment|stonepaste; slip painted and glazed|ceramics'),
  SearchData(-1300, 322889, 'Enthroned deity', 'sculpture|bronze, gold foil|'),
  SearchData(849, 451521, 'Fragment',
      'fragment|earthenware; molded decoration, glazed|ceramics'),
  SearchData(11, 442859, 'Basket Earring',
  ...
  SearchData(849, 451519, 'Fragment',
      'fragment|earthenware; molded decoration, glazed|ceramics'),
  SearchData(1149, 451068, 'Earring, One of a Pair',
      'earring|gold wire with filigree|jewelry'),
  SearchData(1849, 503640, 'Daraboukkeh',
      'daraboukkeh|pottery|membranophone-single-headed / goblet drum'),
  SearchData(-1875, 325093, 'Fenestrated axe blade', 'axe|bronze|'),
  SearchData(-700, 327102, 'Stamp seal (scaraboid) with cultic scene',
      'stamp seal|veined neutral chalcedony (quartz)|'),
  SearchData(-1680, 323126, 'Pin', 'pin|bronze|'),
  SearchData(899, 451537, 'Fragment',
  ...
  SearchData(899, 451538, 'Fragment',
      'fragment|earthenware; splash glazed decoration|ceramics'),
  ...
  SearchData(-750, 326997, 'Stamp seal (scaraboid) with animal',
  ...
  SearchData(1049, 451600, 'Fragment',
  ...
  SearchData(1399, 451555, 'Fragment',
      'fragment|stonepaste; slip painted and glazed|ceramics'),
  ...
  SearchData(
      -50, 325075, 'Fragment of a grave stele', 'relief|alabaster (gypsum)|'),
  SearchData(-1400, 327231, 'Smiting god, wearing an Egyptian atef crown',
      'sculpture|bronze|'),
  SearchData(899, 451534, 'Fragment',
      'fragment|earthenware; molded decoration, glazed|ceramics'),
  SearchData(-600, 323924, 'Stamp seal (loaf-shaped hemispheroid) with animal',
  ...
  SearchData(849, 451529, 'Fragment',
      'fragment|earthenware; molded decoration, glazed|ceramics'),
  SearchData(150, 324319, 'Pitcher', 'pitcher|glass|'),
  SearchData(
      -125, 326694, 'Votive or funerary stele', 'stele|alabaster (gypsum)|'),
  SearchData(
      1330,
      448938,
  ...
  SearchData(849, 451516, 'Fragment',
      'fragment|earthenware; molded decoration, glazed|ceramics'),
  SearchData(-750, 321638, 'Stamp seal (scaraboid) with animals',
      'stamp seal|variegated brown jasper (quartz)|'),
  SearchData(1750, 31745, 'Dagger (Jambiya)',
      'dagger (jambiya)|steel, wood, silver, copper, brass|daggers'),
  SearchData(
      1049, 451607, 'Fragment', 'fragment|earthenware; incised|ceramics'),
  ...
  SearchData(-1966, 545105, 'Head of a sphinx, possibly of Amenemhat I',
      'head, sphinx; 12th-dyn-king|dolomitic marble|'),
  SearchData(
      -750, 324012, 'Stamp seal (scarab) with animal', 'stamp seal|hematite|'),
  SearchData(849, 451563, 'Fragment',
      'fragment|earthenware; slip painted and glazed|ceramics'),
  SearchData(-1630, 324555, 'Scarab seal', 'stamp seal|stone, white|'),
  SearchData(
      899, 451593, 'Fragment', 'fragment|earthenware; splash glazed|ceramics'),
  SearchData(
      1149, 453615, 'Basket Earring, One of a Pair', 'earring|gold|jewelry'),
  ...
  SearchData(1199, 451570, 'Fragment',
      'fragment|stonepaste; slip painted and glazed|ceramics'),
  SearchData(50, 324245, 'Fragment of painted ware', 'sherd|ceramic|'),
  SearchData(50, 325903, 'Lamp', 'lamp|ceramic|'),
  SearchData(849, 451517, 'Fragment',
      'fragment|earthenware; molded decoration, glazed|ceramics'),
  SearchData(-1648, 556529, 'Canaanite Scarab of the "Anra" Type',
      'scarab, "anra"|steatite|'),
  SearchData(
      -900,
      327101,
      'Stamp seal (grooved tabloid) with three-figure contest scene and geometric design',
  ...
  SearchData(
      849, 451542, 'Fragment', 'fragment|earthenware; splash glazed|ceramics'),
  SearchData(1887, 500569, 'Gumuri',
  ...
  SearchData(1199, 451569, 'Fragment',
      'fragment|stonepaste; slip painted and glazed|ceramics'),
  ...
  SearchData(1489, 30812, 'Axe (Berdiche)',
  ...
  SearchData(-750, 327024, 'Stamp seal (scaraboid) with animal',
      'stamp seal|serpentine, black (?)|'),
  SearchData(899, 451531, 'Fragment',
  ...
  SearchData(899, 451541, 'Fragment',
      'fragment|earthenware; slip painted, incised, and splash glazed|ceramics'),
  SearchData(-500, 324027, 'Standing bull', 'sculpture|bronze|'),
  SearchData(
      -1630, 324561, 'Scarab seal', 'stamp seal|steatite, bone colored|'),
  SearchData(-750, 323748, 'Stamp seal (scarab) with anthropomorphic figure',
  ...
  SearchData(-750, 322309, 'Stamp seal (scaraboid) with cultic scene',
      'stamp seal|black limestone|'),
  SearchData(-600, 321633, 'Stamp seal (scaraboid) with animal',
      'stamp seal|neutral chalcedony (quartz)|'),
  SearchData(1875, 500985, 'Stringed Instrument',
  ...
  SearchData(
      ...
      'folio from an illustrated manuscript|ink, opaque watercolor, and gold on paper|codices'),
  SearchData(1449, 451552, 'Fragment',
      'fragment|stonepaste; slip and underglaze painted|ceramics'),
  SearchData(1399, 451557, 'Fragment',
      'fragment|stonepaste; slip painted and glazed|ceramics'),
  SearchData(1049, 451605, 'Fragment', 'fragment|earthenware; glazed|ceramics'),
  SearchData(-1600, 544670, 'Canaanite Scarab with a Lion over a Crocodile',
  ...
  SearchData(849, 451527, 'Fragment',
      'fragment|earthenware; molded decoration, glazed|ceramics'),
  ...
  SearchData(849, 451520, 'Fragment',
      'fragment|earthenware; molded decoration, glazed|ceramics'),
  SearchData(1800, 31772, 'Dagger (Jambiya) with Sheath',
  ...
  SearchData(849, 451561, 'Fragment',
      'fragment|earthenware; slip painted and glazed|ceramics'),
  SearchData(50, 324249, 'Sherd', 'sherd|ceramic|'),
  SearchData(50, 325917, 'Bowl', 'bowl|ceramic|'),
  SearchData(
      -125, 326695, 'Standing male figure', 'sculpture|alabaster (gypsum)|'),
];
