...
class _EventMarkers extends StatefulWidget {
  const _EventMarkers(this.selectedYr,
      {Key? key, required this.onEventChanged, required this.onMarkerPressed})
      : super(key: key);
...
class _EventMarkersState extends State<_EventMarkers> {
  ...
  int get startYr => wonderousLogic.timelineStartYear;

  int get endYr => wonderousLogic.timelineEndYear;
