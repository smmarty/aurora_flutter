...
import 'package:wonderous/ui/common/app_scroll_behavior.dart';

class WonderousAppScaffold extends StatelessWidget {
  const WonderousAppScaffold({Key? key, required this.child}) : super(key: key);
  final Widget child;
